...
### Cleaning GDP data and creating dataframes with geographical features
...
>>>>>>> 010c1e99dc35f994aed1259f28f0c96818c1acdc
...
```
```{r, Alchol beverage pct and GDP growth, message=FALSE, fig.width=14, fig.height=8}  
...
## Transforming the data and determining the optimal K value
```{r transforming data }
...
```
## Have a look at clustered data and create new tables for later analysis
```{r plot clusters}
